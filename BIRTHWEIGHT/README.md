...
Note that the simulation require rougly $3$ minutes on a 2020 Macbook Pro with M1 chip and R 4.1.1 linked with
openblas. For convenience, we store the results in the file `birthweight_sim.RData`
...
kable(t(mae.beta), digits = 2, caption = "MAE")
```
