...
This tutorial is devoted to replicating simulations from @Kosmidis2020, available in Table 2 of the article. Data comprises $n = 100$ births and the binary outcome of interest is a dichotomization of infant birthweight (low against normal). 
